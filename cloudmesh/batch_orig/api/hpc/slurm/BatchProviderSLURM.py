...
from cloudmesh.common.ConfigDict import Config, ConfigDict
from cloudmesh.cloud.hpc.BatchProviderBase import BatchProviderBase
from cloudmesh.db import CloudmeshDatabase
import os
...
class BatchProviderSLURM(BatchProviderBase):
    ...
    def run(cls, cluster, group, cmd, **kwargs):
        ...
        # from cloudmesh.db.model import BATCHJOB
        # name = ""
        # BATCHJOB(name,
